...
class ExpoArgon2Module : Module() {
    private val argon2: Argon2Kt by lazy { Argon2Kt() }

    override fun definition() = ModuleDefinition {
        Name("ExpoArgon2")

        Function("hash", this@ExpoArgon2Module::hash)
        AsyncFunction("hashAsync", this@ExpoArgon2Module::hash)
    }

    private fun hash(password: ByteArray, salt: ByteArray, options: Map<String, Any>): Map<String, Any> {
